...
function BrandIcon({ name }) {
  const logos = {
    facebook: 'https://cdn.jsdelivr.net/gh/glincker/thesvg@main/public/icons/facebook/default.svg',
    github: 'https://cdn.jsdelivr.net/gh/glincker/thesvg@main/public/icons/github/default.svg',
  }
  return <img className="brand-icon" src={logos[name]} alt="" aria-hidden="true" />
}
